      ...
      <header className="header">
        <div className="header-left">
          <div className="wordmark">
            <div className="wordmark-icon">AB</div>
            <div className="wordmark-text">
              <h1>ArchBench</h1>
              <span className="wordmark-badge">Research</span>
            </div>
          </div>
          <p className="subtitle">Monolithic · Microservices · Hybrid — Live Performance Observatory</p>
        </div>
