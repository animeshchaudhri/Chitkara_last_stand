...
export default function ThroughputGauge({ snapshots, colors, labels }) {
  ...
  return (
    <div className="throughput-wrapper-stacked">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={data} margin={{ top: 8, right: 24, left: 0, bottom: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(v) => [`${v} req/min`, 'Throughput']}
              cursor={{ fill: 'rgba(241,245,249,0.03)' }}
            />
            <Bar dataKey="rpm" name="Req/min" radius={[6, 6, 0, 0]} maxBarSize={72}>
              {data.map((entry) => (
